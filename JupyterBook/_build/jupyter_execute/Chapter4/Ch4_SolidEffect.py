...
# The solid-effect is a two-spin mechanism of transfering polarization from electrons to nuclei. It is active when the electron is irradiated with an offset equal to the nuclear Larmor frequency:
# 
# $$
# \begin{equation}
...
# Note that if you set the electron $T_1$ short than half the electron $T_2$, this calculation may diverge.
